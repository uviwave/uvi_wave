function c=cmpnum(y,p)

% CMPNUM	Non-additive cost function: Data compression number.
%
% 		C=CMPNUM(Y,P) where C is the cost of the coefficients Y.
%		A single parameter P is passed to the function.
%		This cost can be used with GROWNON and PRUNENON.
%
%		See also: CMPAREA, WEAKLP, CWENT.
%
