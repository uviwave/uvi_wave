function c=cmparea(y,p)

% CMPAREA	Non-additive cost function: data compression area.
%
% 		C=CMPAREA(Y,P) where C is the cost of the coefficients Y.
%		A single parameter P is passed to the function.
%		This cost can be used with GROWNON and PRUNENON.
%
%		See also: CMPNUM, WEAKLP, CWENT.
%
